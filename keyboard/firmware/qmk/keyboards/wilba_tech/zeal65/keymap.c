...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT_65_normie(
    KC_GESC,       KC_1,    KC_2, KC_3,           KC_4, KC_5, KC_6, KC_7, KC_8,           KC_9,   KC_0,      KC_MINS,  KC_EQL,  KC_BSPACE, KC_F8,
    ...
    KC_TRNS, LEADER,                  LT(ARROWS, KC_SPC),          GENERAL_TAB_RECENT,   EDITOR_BACK_ON_JUMP_LIST,     KC_TRNS, KC_TRNS,   KC_TRNS
  ),

	[NUMPAD] = LAYOUT_65_normie(
	...
	[SYMBOLS] = LAYOUT_65_normie(
		...
		KC_BSLASH, KC_GRAVE,                         KC_TRNS,                                               KC_TRNS, KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS
  ),

	[ARROWS] = LAYOUT_65_normie(
