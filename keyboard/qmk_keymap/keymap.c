...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = KEYMAP(
    ...
    KC_TRANSPARENT , KC_TRANSPARENT , KC_TRANSPARENT , TD(TD_LEFT)      , TD(TD_RIGHT)    ,
  ...
  [SYMBOLS] = KEYMAP(
    ...
    KC_CIRC        , KC_HASH        , KC_TILD        , KC_LPRN        , KC_RPRN        , KC_EQUAL       ,
    KC_TRANSPARENT , KC_DLR         , KC_PERC        , KC_LBRACKET    , KC_RBRACKET    , KC_AMPR        , KC_TRANSPARENT ,
    KC_TRANSPARENT , KC_TRANSPARENT , KC_TRANSPARENT , KC_UNDS        , KC_MINUS       ,
