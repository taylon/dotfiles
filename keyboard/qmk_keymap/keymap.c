...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = KEYMAP(
    // Left hand
    KC_TRANSPARENT, HYPR(KC_1), HYPR(KC_2), HYPR(KC_3), HYPR(KC_4), HYPR(KC_5), TG(QWERTY),
    KC_DELETE, KC_Q, KC_W, LT(NUMPAD, KC_F), LT(MOUSE, KC_P), KC_B, KC_TRANSPARENT,
    KC_BSPACE, GUI_T(KC_A), ALT_T(KC_R), LCTL_T(KC_S), SFT_T(KC_T), KC_G,
    ...
    // Right hand
    TG(LEDS), KC_TRANSPARENT, KC_TRANSPARENT, TD(TD_INDENT), LCTL(KC_BSLASH), TD(TD_FOLD), KC_TRANSPARENT,
    KC_TRANSPARENT, KC_J, KC_L, LT(SYMBOLS, KC_U), KC_Y, KC_SCOLON, KC_TRANSPARENT,
    ...
    KC_TRANSPARENT, TD(TD_LAYER_HUB),
    KC_TRANSPARENT,
  ...
  [LAYER_HUB] = KEYMAP(
    // Left hand
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, TO(QWERTY), KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [RESET_LAYER] = KEYMAP(
    // Left hand
    KC_A, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
...
static uint8_t home_end_state = 0;

bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  // Setup Ctrl+Left/Right to Home/End
  if (keycode == KC_LCTL) {
    if (record->event.pressed)
      home_end_state |= 0b00000001;
    else
      home_end_state &= ~(0b00000001);
  }
  ...
  if (keycode == KC_RIGHT) {
    if (record->event.pressed)
      home_end_state |= 0b00000100;
    else
      home_end_state &= ~(0b00000100);
  }

  if (home_end_state == 0b00000011) {
    SEND_STRING(SS_TAP(X_HOME));
    return false;
  } else if (home_end_state == 0b00000101) {
    SEND_STRING(SS_TAP(X_END));
    return false;
  }


  // Default from ErgodoxEZ
  switch (keycode) {
