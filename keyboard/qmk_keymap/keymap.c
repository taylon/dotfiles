...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = KEYMAP(
    // Left hand
    KC_ESCAPE, LGUI(KC_BSLASH), KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TG(QWERTY),
    ...
    // Right hand
    TG(LEDS), KC_TRANSPARENT, KC_TRANSPARENT, TD(TD_INDENT), KC_TRANSPARENT, LALT(LGUI(KC_LBRACKET)), KC_TRANSPARENT,
