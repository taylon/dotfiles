...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	// Default layer
	[BASE] = LAYOUT_all(
		KC_GESC,       KC_1,    KC_2, KC_3,           KC_4, KC_5, KC_6, KC_7, KC_8,           KC_9,   KC_0,      KC_MINS,  KC_EQL,  KC_BSLS, KC_BSPACE,   KC_F8,
	...
	[ARROWS] = LAYOUT_all(
		...
		KC_TRNS, KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_UP,   KC_DOWN,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                   KC_UP,   KC_TRNS,
