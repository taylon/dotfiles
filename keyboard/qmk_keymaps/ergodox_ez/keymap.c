...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT_ergodox(
    ...
    TD(TD_COPY_CUT), KC_Z, KC_X, KC_C, KC_D, KC_V, KC_TRANSPARENT,
    ...
    // Right hand
    TG(LEDS), KC_TRANSPARENT, KC_TRANSPARENT, LGUI(KC_5), LGUI(KC_BSLASH), TD(TD_FOLD), KC_TRANSPARENT,
    ...
    KC_TRANSPARENT,
    KC_TRANSPARENT, LSFT(KC_ENTER), KC_SPACE
  ),
